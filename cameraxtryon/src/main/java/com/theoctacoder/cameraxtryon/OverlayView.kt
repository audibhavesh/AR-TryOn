...
//            canvas.drawBitmap(it, 0f, 0f, nulpl)
...
//                boundingBox.left.toFloat() - 330,
//                boundingBox.top.toFloat() - 200,
//                null
//            )

//            canvas.drawBitmap(it, left + 250, top, null)
            val paint = Paint().apply {
                shader = BitmapShader(shirtBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP)
                xfermode = PorterDuffXfermode(PorterDuff.Mode.DST_IN)
            }
            canvas.drawBitmap(it, left + 250, top, paint)
        }
    }
...
//        )
        ...
        scaleBitmap?.let {
            boundingBox = calculateBoundingBox(it)
