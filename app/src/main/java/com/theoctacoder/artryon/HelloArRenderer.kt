...
import com.theoctacoder.artryon.helper.DisplayRotationHelper
import com.theoctacoder.artryon.helper.TrackingStateHelper
import com.theoctacoder.artryon.samplerender.Framebuffer
import com.theoctacoder.artryon.samplerender.GLError
import com.theoctacoder.artryon.samplerender.Mesh
import com.theoctacoder.artryon.samplerender.SampleRender
import com.theoctacoder.artryon.samplerender.Shader
import com.theoctacoder.artryon.samplerender.Texture
import com.theoctacoder.artryon.samplerender.VertexBuffer
import com.theoctacoder.artryon.samplerender.arcore.BackgroundRenderer
import com.theoctacoder.artryon.samplerender.arcore.PlaneRenderer
import com.theoctacoder.artryon.samplerender.arcore.SpecularCubemapFilter
...
class HelloArRenderer(val activity: MainActivity) :
    ...
    lateinit var shirtMesh: Mesh
    lateinit var shirtShader: Shader
    lateinit var shirtTexture: Texture
...
//        }
        ...
        for ((anchor, trackable) in wrappedAnchors)
//            .filter { it.anchor.trackingState == TrackingState.TRACKING })
        ...
        activity.segmentCurrentFrame(frame)
...
//
        if (firstHitResult != null) {
            println("DDDDDDD 1 ${hitResultList.toString()} $firstHitResult")
            ...
            println("DDDDDDD 2 ${hitResultList.toString()} $firstHitResult")
        }
    }
